...
player = createSprite(displayWidth-1150, displayHeight-300, 50, 50);
 player.addImage(shooterImg)
   ...
   heart.visible = true
    heart.addImage("heart",heart3Img)
    heart.scale = 0.4
...
if(zombieGroup.isTouching(player)&&(keyWentUp("space"))){
 
  flag = flag + 1;
  if(flag === 1){
    heart.addImage("heart",heart2Img)
  }
...
function enemy(){
  if(frameCount%50===0){
    ...
    zombie = createSprite(1500,random(400,700),40,40)
